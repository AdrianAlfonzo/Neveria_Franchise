 ...
 * @author AA2020
 */
@WebServlet(name = "ActualizarFranquicia", urlPatterns = {"/ActualizarFranquicia"})
public class ActualizarFranquicia extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            oFran.actualizar(Integer.parseInt(pId), oFran);
