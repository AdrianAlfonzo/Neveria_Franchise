 ...
 * @author AA2020
 */
@WebServlet(name = "NuevoFranquicia", urlPatterns = {"/NuevoFranquicia"})
public class NuevoFranquicia extends HttpServlet {
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<!DOCTYPE html>");
                out.println("<html>");
                    ...
                    out.println("<head>");
                        out.println("<title>Nueva Franquicia | La Nevería</title>");
                    out.println("</head>");
                    out.println("<body><form method='post' action='InsertarFranquicia'>");
                    out.println("<body background=\"https://s3-eu-west-1.amazonaws.com/static.lingoda.com/default/0001/12/628ae86177d7ac7f882accb972bf66c18125105f.jpeg\">");
                        ...
                        out.println("<font face=\"Comic Sans MS,arial,verdana\" font size=5px font color=\"white\">");
                            out.println("<h1>Introduce la información del interesado en comprar una franquicia</h1>");
                        out.println("</font>");
                            out.println("<hr>");
                            out.println("<br>");
                                out.println("<div>");
                                ...
                                out.println("</div>");
                            out.println("<input type='Submit'  class=\"btn btn-outline-primary mx-3\" value='AGREGAR NUEVO'></p>");
